        ...
        Thread t = new Thread(new Runnable() {
            ...
            public void run() {
                try{
                    ...
                    //HttpPost httppost = new HttpPost("http://ec2-52-36-149-101.us-west-2.compute.amazonaws.com:8080/register");
                    HttpPost httppost = new HttpPost("http://192.168.1.2:8080/sendtext");
